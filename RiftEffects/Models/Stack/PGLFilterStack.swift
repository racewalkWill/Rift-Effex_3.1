...
//            NSLog("PGLFilterStack #setDefault image color space = \(String(describing: initialImage.colorSpace))")
    ...
    func loadStartup(userStartupImageList: PGLImageList) {
        ...
        // called from the didSet block of PGLSplitViewController.startupImageList
        // PGLSplitViewController #requestStartupImage creates the imageList
...
//                postStackChange()
        ...
        pasteMaskFilter.setImageValue(newValue: pasteImage, keyName:   kUIImagePasteFilter )

        let inputAttribute = pasteMaskFilter.attribute(nameKey: kUIImagePasteFilter)
